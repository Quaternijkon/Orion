...
fn configure_validation(builder: Builder) -> Builder {
    builder
        ...
        .validates(&[
            ...
            ("CreateCollection.auto_shard_policy", ""),
            ("AutoShardPolicy.policy", ""),
            ("OrionAutoShardPolicy.generation", "range(min = 1)"),
            ("OrionAutoShardPolicy.artifact_sha256", "custom(function = \"common::validation::validate_sha256_hash\")"),
            ("SimpleKmeansAutoShardPolicy.generation", "range(min = 1)"),
            ("SimpleKmeansAutoShardPolicy.artifact_sha256", "custom(function = \"common::validation::validate_sha256_hash\")"),
        ...
        .validates(&[
            ...
            ("CoreSearchByShardEntry.search_points", ""),
            ("CoreSearchByShardEntry.final_limit", "range(min = 1)"),
            ("CoreSearchBatchByShardInternal.collection_name", "length(min = 1, max = 255), custom(function = \"common::validation::validate_collection_name_legacy\")"),
            ("CoreSearchBatchByShardInternal.searches", ""),
            ("CoreSearchByShardQueryTemplate.search_points", ""),
            ("CoreSearchByShardCompactEntry.hnsw_ef", "range(min = 1)"),
